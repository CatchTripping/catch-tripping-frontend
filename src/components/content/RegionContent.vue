...
const getAreaImageSrc = (areaId) => {
  return new URL(`/src/assets/area_code/area_code_${areaId}.png`, import.meta.url).href;
};
...
<template>
  <div class="space-y-6">
    <h2 class="text-2xl font-bold">지역</h2>
    ...
    >
      <CarouselContent>
        <CarouselItem v-for="area in areas" :key="area.id" class="basis-1/5">
          <div class="p-1">
            <Button
              :variant="
                hotPlaces.regionCode === area.id ? 'secondary' : 'ghost'
              "
    ...
    <div class="flex items-center gap-2">
      <h3 class="text-lg font-semibold">우리지역,</h3>
      ...
      <span class="text-lg">을 알려드릴게요!</span>
    </div>
